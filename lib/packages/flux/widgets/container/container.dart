    ...
    Widget base = Container(
      ...
      decoration: BoxDecoration(
          ...
          borderRadius: enableBorderRadius ? ( shape == BoxShape.rectangle
              ? borderRadius ??
              BorderRadius.all(Radius.circular(borderRadiusAll ?? FxConstant.constant.containerRadius))
              : null) : null,
          border: bordered
              ? border ??
              Border.all(color: borderColor??FxAppTheme.theme.dividerColor, width: 1)
              : null),
