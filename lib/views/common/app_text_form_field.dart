...
class AppTextFormField extends StatelessWidget {
     const AppTextFormField({Key? key, required this.controller, this.enabled = true, this.hintText = "Enter", this.textAlign = TextAlign.start, this.onChanged}) : super(key: key);
