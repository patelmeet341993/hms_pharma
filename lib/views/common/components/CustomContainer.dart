...
class MyContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<AppThemeProvider>(
      builder: (BuildContext context, AppThemeProvider value, Widget? builderChild) {
        CustomAppTheme customAppTheme = AppTheme.getCustomAppTheme(value.themeMode);
        return InkWell(
          onTap: onTap,
          child: Container(
            width: width,
            ...
            decoration: BoxDecoration(
                  ...
                  border: bordered!
                      ? border ??
                          Border.all(color: customAppTheme.bgLayer1, width: 1)
                      : null),
